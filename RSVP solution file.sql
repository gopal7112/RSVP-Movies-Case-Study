...
-- total_num_of_rows_in_director_mapping  is 3867.
...
-- Hence id, title, year, date_published, duration have no null values.
...
-- The num_of_movies produced in USA or India in the year 2019 are 1059.
...
ORDER BY
   ...
   -- output:
-- genre, num_of_movie_produced_overall
-- Drama=4285,       <- MAX
-- Comedy=2412,
-- Thriller=1484, 
-- Action=1289, 
...
-- Adventure=102,
-- Action=113.              <- MAX
-- The minimum durationof the movie  is the horror while maximum one is Action movie.
...
-- Dream Warrior Pictures and  National Theatre Live  both have the most number of hit movies.
...
-- 361 movies released between 1 April 2018 and 1 April 2019 which have a median rating of 8.
...
-- output:
-- There are 0 null values in name, 17335 null values in height, 13431 null values in date_of_birth and 15226 null values in known_for_movies.
...
RANK() OVER (
ORDER BY 
sum(r.total_votes) DESC) votes_rank
FROM movie m
JOIN ratings r 
on m.id = r.movie_id
...
-- The top actor is Vijay Sethupathi with total votes of 23114 and an average actor rating of 8.42 with 5 movies.
...
-- Therefore the top actresses are Taapsee Pannu, Divya Dutta, Kirti Kharbanda, Sonakshi Sinha.
-- Here Taapsee Pannu tops with total votes of 18061 and average rating of 7.74 with 3 movies.
...
-- Der müde Tod		7.7	Hit
-- Fahrenheit 451	4.9	Flop movies
-- Pet Sematary		5.8	One-time-watch
-- Dukun			6.9	One-time-watch
-- Back Roads		7.0	Hit
-- Countdown		5.4	One-time-watch
-- Staged Killer	3.3	Flop movies
-- Vellaipookal		7.3	Hit
-- Uriyadi 2		7.3	Hit
-- Incitement		7.5	Hit
-- Rakshasudu		8.4	Superhit
-- Trois joursetunevie	6.6	One-time-watch
-- Killer in Law	5.1	One-time-watch
-- Kalki			7.3	Hit
...
-- Adventur	101.87	214.75	107.375000
